...
const Footer: React.FC = () => {
  return (
    <footer id="footer" className="py-8 sm:py-12 bg-muted/60 text-muted-foreground border-t border-border/50">
      <div className="container mx-auto px-4 flex flex-col gap-8 sm:gap-0 sm:flex-row justify-between items-center sm:items-start">
        {/* Contact Section */}
        <div className="w-full sm:w-auto text-center sm:text-left mb-4 sm:mb-0">
          <h3 className="text-base sm:text-xl font-bold mb-2">Contato</h3>
          ...
          <div className="flex flex-row justify-center sm:justify-start items-center gap-4 sm:gap-8">
            ...
            <span className="text-xs sm:text-sm break-all">victorwilva@gmail.com</span>
          </div>
        </div>
      </div>
    </footer>
