...
const HeaderSection: React.FC = () => {
  ...
  return (
    <header className="min-h-screen flex flex-col justify-center items-center py-16 md:py-24 bg-gradient-to-br from-background via-muted/30 to-background relative border-b border-border/20">
      <div className="container mx-auto px-4 text-center">
        <Award className="w-20 h-20 md:w-24 md:h-24 text-accent mx-auto mb-6 animate-bounce" />
