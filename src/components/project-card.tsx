             ...
             <Card className="border-border/30 shadow-md transition-all duration-300 hover:shadow-lg hover:border-primary/30 group/card backdrop-blur-sm mb-4 bg-card/80">
                <CardContent className="p-0">
                  ...
                  <a href={project.link} target="_blank" rel="noopener noreferrer" className="block">
                    <div className="relative w-full aspect-[16/10] rounded-t-lg border-b border-border/30
                    ...
                    before:bg-accent/50 before:rounded-t-lg before:blur-[50px] before:opacity-95
                    group-hover/card:before:opacity-100 group-hover/card:before:scale-115 before:transition-all before:duration-500 before:z-[0]">
                      <Image
                        ...
                        layout="fill"
                        objectFit="cover"
                        className="transition-transform duration-500 group-hover/card:scale-105 relative z-[1] rounded-t-lg overflow-hidden"
